...
function LessonIndex(props) {
 ...
 return (
  <>
    <div>
      <h2>HOW TO TENNIS</h2>
      <h2>Tennis serve and rules</h2>
      <p>A tennis match begins with the umpire doing a coin toss. The player who wins the toss can choose to serve, receive or pick the side from which they want to start the match.
...
<h2>Scoring</h2>
<p>A player or team has to win four points to win a game. Any game starts at 0-0 and the zero point in tennis is called love. The progression of points occurs as follows:
First point - 15
Second point - 30
Third point - 40
Fourth point - Game
...
<h3>SHOTS</h3>
<h3>Forehand and backhand</h3>
<p>The two most common shots in tennis are the forehand and backhand. If a right-handed player extends his right hand to hit the ball from the right side of his body, it is called a forehand.
...
<h3>Drop shot</h3>
<p>When a player reduces the speed of his shot to land the ball just above the net and onto the opposite side, it is called a drop shot.
...
<h3>Smash</h3>
<p>When a player hits a shot with all their power, generally from over their heads, such that the opposing player is unable to reach the ball, it is known as a smash.</p>
<h3>Slice</h3>
<p>A player hits a slice when they cut the ball with the racket facing the court at a cross angle. The slice is generally used to slow down the pace of a rally.</p>
<h3>SETS</h3>
<p>In men’s singles events at Grand Slams, the matches are a best-of-five sets but in all other ATP Tour events, a men’s singles match is a best-of-three sets affair.
